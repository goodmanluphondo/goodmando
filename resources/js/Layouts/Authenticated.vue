<template>
    <div class="font-sans text-sm h-screen antialiased p-14 bg-blue-600">
        <div class="w-full h-full rounded-lg shadow overflow-hidden bg-white">
            <!-- Page Heading -->
            ...
            <!-- Page Content -->
            <main class="w-full flex flew-row">
                <div class="w-60 px-4 sm:px-6 lg:px-8 overflow-hidden border-r">
                    <ul>
                        <li class="py-4">
